...
rmap_c <- robustify(map_hat, weight = 0.12, mean = -50, n=1, sigma = sigma)
...
Finally, the decision rule to claim trial success is $Pr(\mu_T-\mu_C<0|data)>0.95$. This can be evaluated by the following codes. Since the posterior probability 0.987 exceeds the cutoff 0.95, a trial success can be called. 
```{r}
